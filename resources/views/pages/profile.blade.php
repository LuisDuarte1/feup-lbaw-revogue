...
<div class="profile-page">
    <div class="profile-header">
        ...
        @endphp
        <x-profileLayout :profilePicture="$userPicture" :name="$name" :username="$username" :bio="$bio" :rating="$rating" :id="$id" />
    ...
    <div class="profile-products">
        ...
        @endphp
        <x-productCard :price="$price" :image="$image" :size="$size" :id="$id" :shipping="2" :condition="$condition" />
        @endforeach
        <div id="page-end">
        </div>
    </div>
